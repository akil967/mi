			...
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/x_q_9",
                   'caption'=>'𓊈 𝑊𝐸𝐿𝐿𝐶𝑀𝐸 𓊉 𓁹 التفعيل بواسطة @X_Q_9',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'➕ اضافه حسابات وهميه ➕','callback_data'=>'login']],
                       [['text'=>"قناتي ✔ ", 'url'=>"https://t.me/X_Q_9"]],
                    [['text'=>"المطور ➿ ", 'url'=>"https://t.me/M_T_1M"]],
                      ]
                  ])
              ]);
          	...
          	if($config['mode'] != null){
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>' قناتي❗','url'=>'t.me/M_T_1M'],['text'=>'المطور❔','url'=>'t.me/x_q_9']],
                      ]
                  ])
                  ]);
          		    $config['mode'] = null;
...
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                       [['text'=>'قناتي','url'=>'t.me/M_T_1M']],
                       [['text'=>"تواصل", 'url'=>"t.me/x_q_9"]],
